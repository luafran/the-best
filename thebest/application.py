...
APPLICATION = web.Application(
    [
        ...
        (r'.*/api/v2/best_answer', best_answer.BestAnswerHandlerV2,
         {'application_settings': settings, 'handler': 'APIBestAnswerV2'}, 'api_best_answer_v2'),
        ...
        (r'.*/api/v2/system_question', api_system_question.SystemQuestionHandlerV2,
         {'application_settings': settings, 'handler': 'APISystemQuestionV2'}, 'api_system_question_v2'),
